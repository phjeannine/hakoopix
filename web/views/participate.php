    ...
    <div class="row">
      ...
      <div class="content-wrapper">
        ...
        <div class="box box-primary">
          ...
          <!-- form start -->
          <form role="form" class="col-md-offset-1 ol-sm-offset-1" method="POST" action="../public/traitementParticipate.php">
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-success col-md-offset-4 col-md-3 col-sm-offset-4 col-sm-3">Participer</button>
            </div>
          </form>
        </div><!-- /.box -->
