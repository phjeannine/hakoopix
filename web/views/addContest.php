        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-6">
                <div class="form-content">
                    <form method="post" id="add-contest" action="/addContest/insert" class="col-md-offset-1"
                        ...
                        <div class="box-body col-md-11">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="date-first" class="form-control" name="begin"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="date-end" class="form-control" name="ending"
                                               data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                    </div><!-- /.input group -->
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea id="contest-description" class="form-control" name="description"
                                              rows="3"></textarea>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="logo-size-error error">
                                        <p><i class="fa fa-exclamation-triangle"></i> Votre image doit faire 150 x 100
                                            et/ou être de format jpg ou png</p>
                                    </div>
                            ...
                            <input type="button" class="btn btn-primary col-md-6 preview-contest btn-contest"
                                   name="preview-contest" value="Prévisualiser">
                        </div><!-- /.box-body -->
                    </form>
                </div><!-- /.form-content -->
