...
<?php } else { ?>
    <div id="banner" class="container-fluid"
         style="background: url(../../public/images/banner/banner_default.jpg) no-repeat center fixed;">
                ...
                <div class="holder">
                    <div class="inner">
                        ...
                        <?php if ($_SESSION["role"] == "admin") { ?>
                            <p class="contest-description">Aucun concours de créés ou d'actifs. <a href="/addContest"
                                                                                                   title="Créer un concours">Lancez-vous!</a>
                            </p>
                        <?php } ?>
                    </div><!-- /.inner -->
                </div><!-- /.holder -->
        ...
        <div id="rules" class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="rule">
                    ...
                    <p>Partage ta photo avec tes amis et invite les à voter pour toi ! Le gagnant sera cela qui
                        comptabilisera le plus de vote !</p>
                </div>
            </div><!-- /.rule 2 -->
            <!-- Rule 3 -->
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    ...
    <div class="prices-container">
        <div class="container">
            ...
            <div id="prices" class="row">
                ...
                <div class="barre"></div>
                <p class="prices-description">Comme nous savons que tu es gourmand, nous t'avons concocté des petits
                    cadeaux ...</p>
                ...
                <?php foreach ($priceObj1 as $priceObj) : ?>
                    ...
                    <?php if (isset($priceObj['id'])) : ?>
                        ...
                        <?php if ($priceObj['id_contest'] == $id_contest) : ?>
                            ...
                            <div
                                class="price-item col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                                <div class="price">
