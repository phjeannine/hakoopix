            ...
            if ($userParticipate['id_contest'] == $_SESSION['idContest']) { ?>
                <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12 contribution">
                    ...
                    <div class="txt_contest">
                        <h3>
                            <center><?php echo $userParticipate['title']; ?></center>
                        </h3>
                        <div id="contest-desc">
                            <small><?php echo $userParticipate['description']; ?></small>
                        </div>
                        <div class="item-contest">
                            <div class="like"><?php if (!$hasParticipate) {
                                    echo '&nbsp;<a href="/contest/updatelike/' . $userParticipate["id"] . '"><span>like</span></a> ';
                                }
                                echo ' &nbsp;&nbsp;<b style="color:green">&nbsp;votes : ' . $userParticipate["nb_like"] . '</b>'; ?>
                            </div>
                        </div>
                    </div>
                </div>
