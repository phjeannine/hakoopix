                    ...
                    <div class="box-body">
                        ...
                        <select name="contest-name" id="select-contest-name">
                            ...
                            <?php foreach ($contests as $contest) : ?>
                                <option value="<?php echo $contest['title']; ?>"><?php echo $contest['title'] ?>
            ...
            <?php if (isset($_POST['choose-contest-name'])) { ?>
                ...
                <div class="form-content" style="margin-top: 50px;">
                    <form method="post" id="update-contest"
                          action="updateContest/update/<?php echo $contestResult['id'] ?>"
                        ...
                        <div class="box-body col-md-11">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" value="<?php echo $contestResult['title']; ?>"
                                           class="form-control" id="contest-title" name="update-title">
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="date-first"
                                               value="<?php echo $contestResult['date_begin']; ?>" class="form-control"
                                               name="update-begin" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                    </div><!-- /.input group -->
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="date-end"
                                               value="<?php echo $contestResult['date_ending']; ?>" class="form-control"
                                               name="update-ending" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                    </div><!-- /.input group -->
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea id="contest-description" class="form-control" name="update-description"
                                              rows="3"><?php echo $contestResult['description']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="jscolor {hash:true}" name="update-color-theme"
                                           value="<?php echo $contestResult['color_theme']; ?>">
                                </div>
                                <div class="col-md-3 col-md-offset-3"></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="logo-size-error error">
                                        <p><i class="fa fa-exclamation-triangle"></i> Votre image doit faire 150 x 100
                                        </p>
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="banner-size-error error">
                                        <p><i class="fa fa-exclamation-triangle"></i> Votre image doit faire 1250 x 400
                                        </p>
                                    </div>
