            ...
            <nav class="navbar navbar-fixed-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="/"><img alt="Logo" src="<?php echo $logo ?>" id="imgLogo"
                                                              width="40px" height="40px"></a>
                        <?php if ($contestObj->getActiveContest() == FALSE) : ?><a href="#"
                                                                                   onClick="logInWithFacebook()">Connexion
                            Admin</a><?php endif; ?>
                            ...
                            <ul class="nav navbar-nav pull-right">
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" role="button" data-toggle="dropdown"
                                       href="#"><strong><?php echo $_SESSION["name"]; ?> </strong> <span
                                            class="caret"></span></a>
                                    <ul id="g-account-menu" class="dropdown-menu" role="menu">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <hr>
                                            <li><a href="<?php APPLICATION_PATH ?>/public/data/disconnect.php">Déconnexion</a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                <li><a href="<?php APPLICATION_PATH ?>/public/data/disconnect.php"><i
