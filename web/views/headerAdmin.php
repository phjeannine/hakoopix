...
<link rel="stylesheet" href="../templates/admin/dist/css/AdminLTE.css">
...
<div id="dashboard" class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
      ...
      <aside class="main-sidebar">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li><a href="/addContest"><i class="fa fa-pencil"></i> <span>Créer un concours</span></a></li>
            <li><a href="/contestList"><i class="fa fa-clone"></i> <span>Mes concours</span></a></li>
            <li><a href="/addAdmin"><i class="fa fa-user-plus"></i> <span>Ajouter un administrateur</span></a></li>
            <li><a href="#"><i class="fa fa-bar-chart"></i> <span>Statistiques</span></a></li>
            <li><a href="#"><i class="fa fa-cogs"></i> <span>Réglages</span></a></li>
          </ul>
        </section>
        <!-- /.sidebar -->
      </aside>